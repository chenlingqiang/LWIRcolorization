...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal',
    ...
    if netG == 'resnet_9blocks':
        net = cyclegan_networks.ResnetGenerator(input_nc, output_nc, ngf, norm_value, use_dropout, n_blocks=9,
        ...
        net = cyclegan_networks.UNet3Plus(input_nc, output_nc)
    elif netG == 'UnetGenerator':
        net = cyclegan_networks.UnetGenerator(input_nc, output_nc,8, ngf,  use_dropout=use_dropout)
    else:
